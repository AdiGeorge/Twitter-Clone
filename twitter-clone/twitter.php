...
<body>
  ...
  <div id="page">
    <div id="left">
      <a href="/" onclick="showPage('home'); return false" class="active">
      ...
      <a class="logout-container" href="logout.php">
        <img class="logoutimg" src="assets/logout.svg" alt="">
        Logout
      </a>
      <div class="doctype">
        <div>
      ...
      <div id="profile" class="subpage">
        ...
        <div class="main-profile">
          ...
          <div class="user-profile">
            <img class="profileimg" src="assets/profile.jpeg" alt="">
            ...
            <div class="profile-bio">
              ...
              <div class="followers">
                ...
                <p><strong>23.5M</strong> Followers</p>
              </div>
            </div>
    ...
    <div id="right">
      ...
      <div class="trends">
        ...
        <div class="recom">
          <img src="assets/follow1.jpg" alt="">
          <div class="trending-text-flex">
            <h4>Dave Attell</h4>
            <p>@attell</p>
          </div>
